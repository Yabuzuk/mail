...
export class UserResolverBase {
  ...
  @graphql.ResolveField(() => [TokenWallet], { name: "tokenWallets" })
  async findTokenWallets(
    @graphql.Parent() parent: User,
    @graphql.Args() args: TokenWalletFindManyArgs
  ): Promise<TokenWallet[]> {
    const results = await this.service.findTokenWallets(parent.id, args);
  ...
  @graphql.ResolveField(() => [Affiliate], { name: "affiliates" })
  async findAffiliates(
    @graphql.Parent() parent: User,
    @graphql.Args() args: AffiliateFindManyArgs
  ): Promise<Affiliate[]> {
    const results = await this.service.findAffiliates(parent.id, args);
